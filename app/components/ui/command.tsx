...
function CommandList({
  ...
  return (
    <CommandPrimitive.List
      ...
      className={cn(
        "[&::-webkit-scrollbar-thumb]:bg-border/80 max-h-[300px] scroll-py-1 overflow-x-hidden overflow-y-auto [&::-webkit-scrollbar]:w-1.5 [&::-webkit-scrollbar-thumb]:rounded-full",
        className
      )}
      {...props}
    />
